...
CREATE TABLE Players (TeamID INT, PlayerName TEXT, PreviouslyPlayed INT NOT NULL, CONSTRAINT PlayersPK PRIMARY KEY (TeamID, PlayerName), CONSTRAINT PlayersFK FOREIGN KEY (TeamID) REFERENCES Teams(TeamID));
CREATE TABLE Games (GameID INTEGER PRIMARY KEY AUTOINCREMENT, HomeID INT, AwayID INT, GameDate DATE NOT NULL, TossResult TEXT NOT NULL, Decision TEXT NOT NULL, MatchType TEXT NOT NULL, OversOrDays INT NOT NULL, UmpireOne TEXT NOT NULL, UmpireTwo TEXT NOT NULL, GameFinished INT DEFAULT 0, CONSTRAINT HomeFK FOREIGN KEY (HomeID) REFERENCES Teams(TeamID), CONSTRAINT AwayFK FOREIGN KEY (AwayID) REFERENCES Teams(TeamID));
