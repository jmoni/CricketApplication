...
-(void) addHomePlayers{
    ...
    //Players are in database - hometeam
        ...
        homePlayersArray = [instance returnArrayFromDatabase:[NSString stringWithFormat:@"SELECT PlayerName FROM Players WHERE TEAMID = '%d' AND PreviouslyPlayed > 0",
                                 homeTeamID]];
    }
}
...
-(void) addAwayPlayers{
    ...
    //Players are in database - hometeam
        ...
        awayPlayersArray = [instance returnArrayFromDatabase:[NSString stringWithFormat:@"SELECT PlayerName FROM Players WHERE TEAMID = '%d' AND PreviouslyPlayed >0",
                                 awayTeamID]];
    }
}
